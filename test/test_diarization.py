...
"""
# Criando testes unitários para a diarização real via pyannote 
import pytest
...
from diarização_reality.whisper_with_diarization import WhisperWithDiarization


# ── Fixtures ──────────────────────────────────────────────────────────────
# Criando fixture para simular a saida da pyannote com segmentos de falha e identificação de speakers 
@pytest.fixture
...
# Criando fixture para simular a saída do Whisper com segmentos de texto e timestamps
@pytest.fixture
...
# Criando mocks para as interfaces do Whisper e Pyannote,
#  permitindo a testar a integração entre eles sem depender do modelo real ou da API do Hugginface
@pytest.fixture
...
# Criando Mock para o PyannoteDiarizer, simulando a saida típica de
#  diarização com segmentos de fala e indetificação de speakers 
@pytest.fixture
...
# Classe de teste para o PyannoteDiarizer, testando a validação de arquivos, parsing de saída e tratamento de erros de importação 
...
# Classe de teste para o WhisperWithDiarization, testando a integração entre a transcrição do Whisper e a diarização do Pyannote 
...
# Criando classe de teste de alinhamento isolada, testando a lógica de identificação do speaker dominante com base na sobreposição de tempo entre os segmentos do Whisper e do Pyannote 
